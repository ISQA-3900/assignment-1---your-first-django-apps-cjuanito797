...
class ll_ATS(unittest.TestCase):
    ...
    def test_ll(self):
        ...
        time.sleep(3)
        elem = driver.find_element_by_xpath("/html/body/div/div/div[1]/ul[1]/li[4]/a").click()
        time.sleep(3)
        ...
        try:
            ...
            elem = driver.find_element_by_xpath("/html/body/div/div/div[1]/ul[1]/li[2]/a").click()
